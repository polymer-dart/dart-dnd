...
class Dropzone {
  ...
  /// class is added.
  Dropzone(elementOrElementList, {this.acceptor: null, this.overClass: 'dnd-over', this.invalidClass: 'dnd-invalid'}) : this._elementOrElementList = elementOrElementList {
